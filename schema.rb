ActiveRecord::Schema.define(version: 2025_04_09_000000) do
    ...
    create_table "fdts", force: :cascade do |t|
      t.string "fdt_id", null: false
    ...
    create_table "pelanggans", force: :cascade do |t|
      t.string "id_permohonan", null: false
      t.string "sid"
      t.string "cust_name"
      t.string "telpn"
      t.float "latitude_pelanggan"
      t.float "longitude_pelanggan"
      t.references "fat", foreign_key: true
      t.string "notes"
      t.timestamps
    end
    ...
    create_table "home_connecteds", force: :cascade do |t|
      t.integer "hc_old"
      t.integer "hc_icrm"
      t.integer "total_hc"
    ...
    create_table "dokumentasis", force: :cascade do |t|
      t.string "status_osp_amarta_fat"
